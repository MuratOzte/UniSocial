...
const UserProfileHeader = ({ uidata }) => {
  console.log(uidata);
      ...
      >
        <div className="w-[500px] h-[200px] absolute left-4 top-[75px] rounded-md flex gap-5">
          ...
          <div className="flex flex-col justify-center text-white space-y-3">
            ...
            <button
              className="mt-4 px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-full shadow-md"
              onClick={() => alert(`Followed ${uidata.name}!`)}
            >
              Follow
            </button>
          </div>
